...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference("Badge.count") do
      post badges_url, params: { badge: { image: @badge.image, rule: @badge.rule, rule_value: @badge.rule_value, title: @badge.title } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { image: @badge.image, rule: @badge.rule, rule_value: @badge.rule_value, title: @badge.title } }
